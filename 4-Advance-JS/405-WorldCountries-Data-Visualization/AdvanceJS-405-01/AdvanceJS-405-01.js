...
for (let i = 0; i < countries_data.length; i++) {
	...
	for (let j = 0; j < countries_data[i]["languages"].length; j++) {
		// console.log(countries_data[i]["languages"][j])
		if (countries_data[i]["languages"][j] === "English")
			englishCount++;
		else if (countries_data[i]["languages"][j] == "French") {
			FrenchCount++;
		}
		else if (countries_data[i]["languages"][j] === "Arabic")
			arabicCount++;
		else if (countries_data[i]["languages"][j] === "Spanish")
			spanishCount++;
		else if (countries_data[i]["languages"][j] === "Portuguese")
			portugueseCount++;
		else if (countries_data[i]["languages"][j] === "Russian")
			russianCount++;
		else if (countries_data[i]["languages"][j] === "Dutch")
			dutchCount++;
		else if (countries_data[i]["languages"][j] === "German")
			germanCount++;
		else if (countries_data[i]["languages"][j] === "Chinese")
			chineseCount++;
		else if (countries_data[i]["languages"][j] === "Serbian")
			serbianCount++;
	}
}
...
let data = [englishCount, FrenchCount, arabicCount, spanishCount, portugueseCount, russianCount, dutchCount, germanCount, chineseCount, serbianCount];
